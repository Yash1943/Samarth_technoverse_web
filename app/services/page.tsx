        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service) => (
              <Card key={service.id} className="group border transition-all duration-300 hover:shadow-lg hover:border-primary/20">
                <CardHeader>
        ...
        <div className="container">
          <div className="bg-card border rounded-xl overflow-hidden shadow-lg">
            <div className="grid md:grid-cols-2">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-teal-500 p-8 md:p-12 text-white flex items-center">
                <div>
